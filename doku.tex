...
\newcommand*{\AuthorAMatrikel}	    {18-156-703}
\newcommand*{\AuthorB}				{ Fuchs}
...
\newcommand*{\Title}            	{Database Change Management Techniques}
\newcommand*{\Subtitle}            	{by the Example of PostgreSQL}
...
\include{chapters/lesson_learned/lesson_learned}
